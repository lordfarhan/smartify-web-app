...
@section('title')
    Record Attendance - {{\Carbon\Carbon::parse($schedule->date)->format('M, d Y')}}
@endsection
                            ...
                            <td>
                                ...
                                <div class="form-group clearfix">
                                    <div class="icheck-success d-inline">
                                        ...
                                        <input name="status[{{$key}}]" type="hidden" value="0" id="checkboxAbsent-{{$key}}"> --}}
                                        <input type="hidden" name="status[{{$key}}]" value="0"><input type="checkbox" onclick="this.previousSibling.value=1-this.previousSibling.value" id="checkboxPresent-{{$key}}">
