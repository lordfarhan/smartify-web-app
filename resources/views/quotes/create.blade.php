...
@section('content')
	<div class="row">
		<div class="col-12">
			{{ Form::open(array('route' => 'quotes.store', 'method'=>'POST', 'files' => true)) }}
				<div class="card">
                ...
                <div class="form-group">
                  ...
                  {{ Form::select('quote_category_id', $categories, null, array('class' => 'form-control', 'placeholder' => __('common.quotes.attributes.category'))) }}
                </div>
								<div class="form-group">
									{{ Form::label('quote', __('common.quotes.attributes.quote')) }}
									{{ Form::textarea('quote', null, array('placeholder' => __('common.quotes.attributes.quote'), 'class' => 'form-control')) }}
								</div>
								<div class="form-group">
									{{ Form::label('author', __('common.quotes.attributes.author')) }}
									{{ Form::text('author', null, array('placeholder' => __('common.quotes.attributes.author'), 'class' => 'form-control')) }}
                </div>
                <div class="form-group">
